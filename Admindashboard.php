    ...
    <body>
        <form action="" method="post">
            ...
            <main>
                ...
                <div class="sectiongroup" style="max-width:1100px; margin: 0 auto;">
                    <div class="col_1_of_4 span_1_of_4">
                        ...
                        echo '<div style="height: 230px; display: flex; align-items: center; justify-content: center; overflow: hidden;"><p style="font-size: 50px; text-align:center; margin-top: 50px;">' . $row . '</p></div>';
                        ?>
                    </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div style=" text-align:justify;width:100%;padding-bottom:10px;">
                                                <?php
                                                $sql = "SELECT * FROM `alumni_master` ORDER BY sr_no DESC LIMIT 5";
                                                $result = mysqli_query($con, $sql);
