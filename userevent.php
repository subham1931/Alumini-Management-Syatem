            ...
            <div class="main">
                ...
                <div class="container" style="width: 1100px;">
                    ...
                    <?php
                        ...
                        $sql2="SELECT * FROM `event_master`  WHERE course_id= $course and session_id= $session";
                    ...
                    <div class="panel-group" id="accordion">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                ...
                                <?php echo $row["tittle"];?></a>
                                </h4>
                            </div>
                            <div id=<?php $id; ?>  class="panel-collapse collapse">
                                <div class="panel-body">
                                    <img src="<?php echo "event_banner/".$row["photo"];?>" height="200px" width="1000px"><br>
