<?php
    ...
    header('location:login.php');
        ...
        if(isset($_POST['save'])){
            ...
            $query1="INSERT INTO `notice_master` VALUES ('','$course_id','$session_id','$tittle','$ndescription',current_timestamp())";
...
<html lang="en">
    ...
    <form action="" method="post">
        ...
        <main>
            <div class="main">
                <h2 style="text-align:center; padding-top:50px;">Add Notice</h2>
                ...
                <div class="inner-con">
                    ...
                    <input type="text" name="tittle" id="tittle" placeholder="Enter your Tittle" required><br><br>
                    
                    <label for="ndescription" >Description</label><br>
                    <input type="textarea" name="ndescription" id="ndescription" placeholder="Enter Notice Description" required><br><br>
